...
public class QuanJeanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    Context context;
    List<SanPham> array;
    private static final int VIEW_TYPE_DATA = 0;
    private static final int VIEW_TYPE_LOADING = 1;

    public QuanJeanAdapter(Context context, List<SanPham> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_DATA){
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quanjean, parent, false);
...
//            myViewHolder.mota.setText(sanPham.getMoTa());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itemqj_ten);
            giasp = itemView.findViewById(R.id.itemqj_gia);
//            mota = itemView.findViewById(R.id.itemak_mota);
            hinhanh = itemView.findViewById(R.id.itemqj_image);
